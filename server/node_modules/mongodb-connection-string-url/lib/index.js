...
function connectionStringHasValidScheme(connectionString) {
    return (connectionString.startsWith('mongodb://') ||
        connectionString.startsWith('mongodb+srv://REDACTEDREDACTEDREDACTED'));
}
...
class ConnectionString extends URLWithoutHost {
    constructor(uri, options = {}) {
        ...
        if (!looseValidation && !connectionStringHasValidScheme(uri)) {
            throw new MongoParseError('Invalid scheme, expected connection string to start with "mongodb://" or "mongodb+srv://REDACTEDREDACTEDREDACTED"');
        }
